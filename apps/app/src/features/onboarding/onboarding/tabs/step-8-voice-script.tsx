...
interface Step8VoiceScriptProps {
  // biome-ignore lint/suspicious/noExplicitAny: Form type is dynamic based on onboarding step
  form?: UseFormReturn<any>;
  organizationId?: string;
}

export function Step8VoiceScript({ organizationId }: Step8VoiceScriptProps) {
      ...
      >
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium">Qualification Questions</span>
