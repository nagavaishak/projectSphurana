...
export const FirstIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="12"
      height="13"
...
export const SecondIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="12"
      height="13"
...
export const ThirdIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="12"
      height="13"
...
export const FifthIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="12"
      height="13"
