export const ArrowIllustration = (
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <path d="M173.838 137.814L171.849 140.157L154.299 150.29L155.909 148.392C156.218 148.028 156.564 147.734 156.941 147.507L156.94 147.506L173.956 137.684C173.917 137.727 173.876 137.769 173.838 137.814Z" />
        </clipPath>
        <clipPath
        ...
        >
          <path d="M141.083 125.565C142.464 124.735 144.282 124.793 146.205 125.653C148.127 126.512 150.14 128.168 151.892 130.509L154.398 133.859L136.491 144.197L133.971 140.828C132.203 138.465 130.163 136.782 128.202 135.905C126.781 135.269 125.395 135.057 124.184 135.321L141.082 125.566L141.083 125.565Z" />
        </clipPath>
        <clipPath
        ...
        >
          <path d="M45.6504 50.7241C41.4464 53.8557 37.9631 58.0924 35.3213 63.2925C34.9344 64.0541 34.426 64.6321 33.8281 65.0337L16.6602 74.9448C16.9467 74.6259 17.2028 74.2559 17.4189 73.8306C20.7313 67.3105 25.3688 62.3186 31.0879 59.1323L31.0889 59.1313L45.6504 50.7241Z" />
        </clipPath>
        <clipPath
...
export const ArrowIconReverse = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      width="191"
      height="198"
